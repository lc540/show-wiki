# 03-集成数据连接池
```
 基于SpringBoot2.7.18，构建的示例项目，增加mysql和druid配置
```
## 00相关说明
```
配置数据库使用mysql
...
------
著作权归@pdai所有
原文链接：https://pdai.tech/md/spring/springboot/springboot-x-mysql-druid.html
```

mvn-my package
java -jar target/boot-0.0.1.jar

在浏览器访问地址：http://localhost:8080/druid/datasource.html  账号：admin / admin
